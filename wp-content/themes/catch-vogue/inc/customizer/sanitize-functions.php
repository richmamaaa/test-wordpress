 ...
 */
function catch_vogue_sanitize_select( $input, $setting ) {
 ...
 */
function catch_vogue_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function catch_vogue_sanitize_post( $input ) {
 ...
 */
function catch_vogue_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function catch_vogue_sanitize_category_list( $input ) {
	if ( '' != $input ) {
		if( in_array( 0, $input ) ) {
			return '0';
		}
