...
jQuery(function($){
    ...
    function initMainNavigation( container ) {
        ...
        var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false })
            .append( catchVogueScreenReaderText.icon )
            .append( $( '<span />', { 'class': 'screen-reader-text', text: catchVogueScreenReaderText.expand }) );
        ...
        container.find( '.dropdown-toggle' ).click( function( e ) {
            ...
            // jscs:enable
            screenReaderSpan.text( screenReaderSpan.text() === catchVogueScreenReaderText.expand ? catchVogueScreenReaderText.collapse : catchVogueScreenReaderText.expand );
        } );
    }
